<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true" CodeBehind="link.aspx.cs" Inherits="aviation.link" %>
...
<!-- Here's the box for some pics, remove if not a photo gallery -->
    ...
    <p class="style3">
     ...
     &nbsp;<img src="images/airasia.png" alt="help" class="pickboxcontrol" 
             width="80px" /> &nbsp; &nbsp;&nbsp;<asp:HyperLink ID="HyperLink1" runat="server" 
