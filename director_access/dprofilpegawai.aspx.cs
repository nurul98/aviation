...
{
    public partial class dprofilpegawai : System.Web.UI.Page
    {
        ...
        static string pegawaiid, bahagian;
        ...
        private void onload()
        {
            ...
            if (readerdept.Read())
            {
                bahagian = readerdept["bahagian"].ToString();
            }
            ...
            SqlCommand sqlCommand = new SqlCommand("SELECT * FROM profil_pegawai WHERE bahagian=@bahagian ORDER BY nama", sqlConnection);
            sqlCommand.Parameters.Clear();
            sqlCommand.Parameters.AddWithValue("@bahagian", bahagian);
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlCommandreadstatus = new SqlCommand("SELECT * FROM profil_pegawai WHERE username=@username AND bahagian=@bahagian", sqlConnectionstatus);
            sqlCommandreadstatus.Parameters.Clear();
            sqlCommandreadstatus.Parameters.AddWithValue("@username", txtSearch.Text);
            sqlCommandreadstatus.Parameters.AddWithValue("@bahagian", bahagian);
            ...
            SqlCommand sqlCommandreadstatus2 = new SqlCommand("SELECT * FROM profil_pegawai WHERE username=@username AND bahagian=@bahagian", sqlConnectionstatus);
            sqlCommandreadstatus2.Parameters.Clear();
            sqlCommandreadstatus2.Parameters.AddWithValue("@username", txtSearch.Text);
            sqlCommandreadstatus2.Parameters.AddWithValue("@bahagian", bahagian);
            ...
            {
                MessageBox.Show("IC Pegawai yang anda cari tiada dalam rekod bahagian ini...");
            }
