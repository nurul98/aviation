...
{
    public partial class dsenaraipengarah : System.Web.UI.Page
    {
        ...
        private void onload()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("SELECT p.username,p.nama,p.jawatan,p.bahagian,p.telefon_bimbit,p.telefon_pejabat,p.email FROM profil_pegawai p, director d WHERE p.username = d.ic ORDER BY p.nama", sqlConnection);
