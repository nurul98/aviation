<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true" CodeBehind="tiketsehala.aspx.cs" Inherits="aviation.tiketsehala" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:HyperLink ID="linksehala" runat="server" 
        NavigateUrl="~/BookingApplication.aspx">klik di sini </asp:HyperLink>untuk menempah tiket dua hala<br /><br />
  <table class="style1">
