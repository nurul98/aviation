<%@ Page Title="" Language="C#" MasterPageFile="~/director_access/director.Master" AutoEventWireup="true" CodeBehind="homedirector.aspx.cs" Inherits="aviation.director_access.homedirector" %>
                            ...
                            <tr>
                                <td align="right" colspan="2">
                                    <asp:Button ID="ContinuePushButton" runat="server" CausesValidation="False" 
                                        CommandName="Continue" PostBackUrl="~/director_access/homedirector.aspx" Text="Continue" />
                                </td>
                            </tr>
                        </table>
                    </td>
