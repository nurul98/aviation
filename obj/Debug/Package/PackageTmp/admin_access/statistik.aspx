<%@ Page Title="" Language="C#" MasterPageFile="~/admin_access/admin.Master" AutoEventWireup="true" CodeBehind="statistik.aspx.cs" Inherits="aviation.admin_access.statistik" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
   ...
   <tr><td><asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/admin_access/images/flight_icon.jpg" 
           PostBackUrl="~/admin_access/statistiktiket.aspx" /></td>
           <td><asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/admin_access/images/company.jpg" 
           PostBackUrl="~/admin_access/statistikbahagian.aspx" /></td></tr>
