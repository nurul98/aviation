<%@ Page Title="" Language="C#" MasterPageFile="~/admin_access/admin.Master" AutoEventWireup="true" CodeBehind="tiketsehalaadmin.aspx.cs" Inherits="aviation.admin_access.tiketsehalaadmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <h1>Tiket Sehala</h1><br />
     Sila 
    <asp:HyperLink ID="linksehalaadmin" runat="server" 
        NavigateUrl="~/admin_access/adminbooking.aspx">klik di sini </asp:HyperLink>untuk menempah tiket dua hala<br /><br />
        <table class="style1">
 ...
 <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
     ...
     <SelectParameters>
         <asp:Parameter DefaultValue="pegawai" Name="pangkat" Type="String" />
