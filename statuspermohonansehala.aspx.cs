...
namespace aviation
{
    public partial class statuspermohonansehala : System.Web.UI.Page
    {
        ...
        private void onload()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("SELECT * FROM tiket_sehala WHERE username_pegawai=@username_pegawai ORDER BY tarikh_pergi", sqlConnection);
        ...
        {
            Response.Redirect("lihatfailsokongansehala.aspx?tiketid=" + id.Text);
        } 
        protected void btnEdit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (userreader.Read())
                {
                    ...
                    {
                        LabelStatus.Text = "Status permohonan " + tiketid + " telah telah disokong oleh penyelia. Butir-butir perjalanan adalah seperti berikut.";
                    ...
                    else if (String.Compare(status_lulus, "Tidak Lulus") == 0)
                    {
                        ...
                        LabelStatus.Text = "Maaf, status permohonan " + tiketid + " tidak disokong oleh penyelia.";
        ...
        protected void confirmdelete_Click(object sender, EventArgs e)
        {
            ...
            usercommand.CommandText = "SELECT * FROM tiket_sehala WHERE id=@id AND lulus=@lulus";
            usercommand.Parameters.Clear();
            usercommand.Parameters.AddWithValue("@id", tiketid);
