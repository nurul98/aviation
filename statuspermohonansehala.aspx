<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true" CodeBehind="statuspermohonansehala.aspx.cs" Inherits="aviation.statuspermohonansehala" %>
...
Sila <asp:HyperLink ID="linkpermohonan" runat="server" 
        NavigateUrl="~/statuspermohonan.aspx">klik di sini </asp:HyperLink>untuk status permohonan tiket dua hala
&nbsp;<br />
           ...
           <tr>
            ...
            <tr>
             ...
             <tr>
                ...
                <td>
                    <asp:LinkButton ID="linkfile" runat="server" onclick="linkfile_Click" Visible="False">Lihat Dokumen</asp:LinkButton>
                </td>
            </tr>
        </table>
         <br />
