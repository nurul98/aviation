<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true" CodeBehind="BookingApplication.aspx.cs" Inherits="aviation.BookingApplication" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    Sila 
    <asp:HyperLink ID="linksehala" runat="server" NavigateUrl="~/tiketsehala.aspx">klik di sini </asp:HyperLink>untuk menempah tiket sehala<br />
&nbsp;<table class="style1">
 ...
 <tr>
     ...
     ControlToValidate="TxtTarikhBalik" CssClass="ErrorMessage">Sila masukkan tarikh balik</asp:RequiredFieldValidator> </td>
       </tr>
       <tr>
        <td class="style8">
            Waktu Perjalanan:&nbsp;&nbsp;&nbsp;&nbsp; </td>
             ...
             <tr>
                ...
                <td class="style3">
                    ...
                    <td class="style7">
                        ...
                        nombor penerbangan dipilih telah penuh.<br />
                        <br />
                        </td>
            </tr>
             <tr>
