<%@ Page Title="" Language="C#" MasterPageFile="~/supervisor_access/supervisor.Master" AutoEventWireup="true" CodeBehind="status.aspx.cs" Inherits="aviation.supervisor_access.status" %>
...
Sila 
    ...
    <asp:HyperLink ID="linkpermohonan" runat="server" 
        NavigateUrl="~/supervisor_access/statussehala.aspx">klik di sini </asp:HyperLink>untuk status permohonan tiket sehala
&nbsp;<br />
...
<asp:HyperLink
        ...
        NavigateUrl="~/supervisor_access/superbook.aspx">klik di sini </asp:HyperLink>
             ...
             <tr>
                ...
                <td>
                    <asp:LinkButton ID="linkfile" runat="server" onclick="linkfile_Click" 
                        Visible="False">Lihat Fail</asp:LinkButton>
                </td>
            </tr>
