<%@ Page Title="" Language="C#" MasterPageFile="~/supervisor_access/supervisor.Master" AutoEventWireup="true" CodeBehind="pengesahansokongan.aspx.cs" Inherits="aviation.supervisor_access.pengesahansokongan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
  ...
  <asp:HyperLink ID="linksehalaadmin" runat="server" 
        NavigateUrl="~/supervisor_access/pengesahansokongansehala.aspx">klik di sini </asp:HyperLink>untuk sahkan permohonan tiket sehala<br />
   <br />
    <asp:GridView ID="gdvPending" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="tarikh_balik" HeaderText="Tarikh Balik" DataFormatString="{0:d}"/>
            ...
            <tr>
                <td class="style3">
                    <asp:Label ID="LabelTarikhBalik" runat="server" Text="Tarikh Balik:" 
                        Visible="True" CssClass="style1"></asp:Label>  </td>
                <td>
                    <asp:TextBox ID="tarikhbalik" runat="server" Width="60px" Visible="True"></asp:TextBox>
                </td>
            </tr>
           ...
           <tr>
                <td class="style3">
                    <asp:Label ID="LabelWaktuPerjalanan2" runat="server" Text="Waktu Perjalanan:" 
                        Visible="True" CssClass="style1"></asp:Label>  </td>
                <td>
                     <asp:TextBox ID="waktuperjalanan2a" runat="server" Width="60px"></asp:TextBox>
                </td>
            </tr>
           <tr>
                <td class="style3">
