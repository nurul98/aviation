<%@ Page Title="" Language="C#" MasterPageFile="~/supervisor_access/supervisor.Master" AutoEventWireup="true" CodeBehind="superbook.aspx.cs" Inherits="aviation.supervisor_access.superbook" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    Sila 
    <asp:HyperLink ID="linksehala" runat="server" NavigateUrl="~/supervisor_access/superbooksehala.aspx">klik di sini </asp:HyperLink>untuk menempah tiket sehala<br />
&nbsp;<table class="style1">
