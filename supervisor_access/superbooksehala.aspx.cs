...
{
    public partial class superbooksehala : System.Web.UI.Page
    {
        ...
        protected void tempah()
        {
            ...
            updatecommand2.CommandText = "INSERT INTO tiket_sehala (id,username_pegawai,nama,tarikh_tempahan,masa_tempahan,tempat_perjalanan,arah_perjalanan,jenis,tarikh_pergi,waktu_perjalanan1,cara_perjalanan,tujuan_perjalanan,catatan,bilangan_penumpang,nama_penyelia,email_penyelia,status,lulus,FileName,MIME,BinaryData,pangkat) VALUES "

                        + " (@id,@username_pegawai,@nama,@tarikh_tempahan,@masa_tempahan,@tempat_perjalanan,@arah_perjalanan,@jenis,@tarikh_pergi,@waktu_perjalanan1,@cara_perjalanan,@tujuan_perjalanan,@catatan,@bilangan_penumpang,@nama_penyelia,@email_penyelia,@status,@lulus,@FileName,@MIME,@BinaryData,@pangkat)";
            ...
            updatecommand2.Parameters.AddWithValue("@pangkat", "penyelia");
        ...
        {
            Response.Redirect("superbooksehala.aspx");
        }
    }
}