<%@ Page Title="" Language="C#" MasterPageFile="~/supervisor_access/supervisor.Master" AutoEventWireup="true" CodeBehind="statistik.aspx.cs" Inherits="aviation.supervisor_access.statistik" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
 <table align="center">
   <tr><td><asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/admin_access/images/flight_icon.jpg" 
           PostBackUrl="~/supervisor_access/statistiktiket.aspx" /></td>
           <td><asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/admin_access/images/company.jpg" 
           PostBackUrl="~/supervisor_access/statistikbahagian.aspx" /></td></tr>
