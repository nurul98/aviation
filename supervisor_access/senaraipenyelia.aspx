<%@ Page Title="" Language="C#" MasterPageFile="~/supervisor_access/supervisor.Master" AutoEventWireup="true" CodeBehind="senaraipenyelia.aspx.cs" Inherits="aviation.supervisor_access.senaraipenyelia" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
<h2>Senarai Penyelia</h2>
...
<asp:GridView ID="gridpenyelia" runat="server" AutoGenerateColumns="False" 
         ...
         onpageindexchanging="gridpenyelia_PageIndexChanging">
                   <Columns>
                       <asp:BoundField DataField="username" HeaderText="IC Penyelia" SortExpression="username" Visible="False" />
                       ...
                       <asp:TemplateField HeaderText="Telefon Bimbit" SortExpression="telefon_bimbit" Visible="False">
                        <ItemTemplate>
