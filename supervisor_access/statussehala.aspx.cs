...
{
    public partial class statussehala : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("superlihatfailsokongansehala.aspx?tiketid=" + id.Text);
        }
        protected void btnEdit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (userreader.Read())
                {
                    ...
                    {
                        LabelStatus.Text = "Status permohonan " + tiketid + " telah telah disokong oleh pengarah. Butir-butir perjalanan adalah seperti berikut.";
