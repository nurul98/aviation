...
namespace aviation.supervisor_access
{
    ...
    {
        static string strSQLconnection = @"Data Source=(LocalDb)\v11.0;AttachDbFilename=|DataDirectory|\aviation.mdf; Trusted_Connection=True;Max Pool Size = 100;User Instance=True";
        ...
        private void getmonthduahala()
        {
            for (int count = 0; count < gdvDuaHala.Rows.Count; count++)
            {
                try
                {
                    ...
                    string strSQLconnectionmonth = @"Data Source=(LocalDb)\v11.0;AttachDbFilename=|DataDirectory|\aviation.mdf; Trusted_Connection=True;Max Pool Size = 100;User Instance=True";
        ...
        private void bahagiantiketduahala()
        {
            for (int count = 0; count < gdvDuaHala.Rows.Count; count++)
            {
                try
                {
                    ...
                    string strSQLconnectiondept2 = @"Data Source=(LocalDb)\v11.0;AttachDbFilename=|DataDirectory|\aviation.mdf; Trusted_Connection=True;Max Pool Size = 100;User Instance=True";
                    ...
                    string strSQLconnectiondept = @"Data Source=(LocalDb)\v11.0;AttachDbFilename=|DataDirectory|\aviation.mdf; Trusted_Connection=True;Max Pool Size = 100;User Instance=True";
