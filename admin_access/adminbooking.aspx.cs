...
namespace aviation.admin_access
{
    public partial class adminbooking : System.Web.UI.Page
    {
        ...
        protected void tempah()
        {
            ...
            sqlCommandread4.Parameters.AddWithValue("@username_pegawai", TxtIC.Text);
            ...
            sqlCommandread4a.Parameters.AddWithValue("@username_pegawai", TxtIC.Text);
            ...
            sqlCommandread4b.Parameters.AddWithValue("@username_pegawai", TxtIC.Text);
