...
{
    public partial class senaraitempahansehala : System.Web.UI.Page
    {
        ...
        static string tiketid,icpegawai;
        ...
        private void onload()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("SELECT * FROM tiket_sehala ORDER BY tarikh_tempahan,masa_tempahan", sqlConnection);
        ...
        {
            Response.Redirect("lihatfailsehala.aspx?tiketid=" + id.Text);
        }
        ...
        protected void okfailbaru_Click(object sender, EventArgs e)
        {
            ...
            updatecommand.CommandText = "UPDATE tiket_sehala SET FileName=@FileName,MIME=@MIME,BinaryData=@BinaryData WHERE id=@id";
        ...
        protected void update_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlCommandread = new SqlCommand("SELECT status,lulus,id FROM tiket_sehala WHERE status=@status AND lulus=@lulus AND id=@id", sqlConnection);
            ...
            updatecommand.CommandText = "UPDATE tiket_sehala SET username_pegawai=@username_pegawai,tempat_perjalanan=@tempat_perjalanan,arah_perjalanan=@arah_perjalanan,jenis=@jenis,tarikh_pergi=@tarikh_pergi,waktu_perjalanan1=@waktu_perjalanan1,tujuan_perjalanan=@tujuan_perjalanan,catatan=@catatan,bilangan_penumpang=@bilangan_penumpang,nama_penyelia=@nama_penyelia,email_penyelia=@email_penyelia WHERE id=@id";
        ...
        protected void confirmdelete_Click(object sender, EventArgs e)
        {
            ...
            deletecommand.CommandText = "DELETE FROM tiket_sehala WHERE id=@id";
        ...
        protected void tukarstatus_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlCommandread = new SqlCommand("SELECT status,id FROM tiket_sehala WHERE status=@status AND id=@id", sqlConnection);
            sqlCommandread.Parameters.Clear();
            ...
            updatecommand = new SqlCommand();
            updatecommand.Connection = updateconnection;
            updatecommand.CommandText = "UPDATE tiket_sehala SET lulus=@lulus WHERE id=@id";
        ...
        protected void oktarikhpergi_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlCommandread = new SqlCommand("SELECT * FROM tiket_sehala WHERE status=@status AND lulus=@lulus AND id=@id", sqlConnection);
            sqlCommandread.Parameters.Clear();
            sqlCommandread.Parameters.AddWithValue("@status", "Dalam Pertimbangan");
            sqlCommandread.Parameters.AddWithValue("@lulus", "Dalam Pertimbangan");
            sqlCommandread.Parameters.AddWithValue("@id", tiketid);
            ...
            updatecommand.CommandText = "UPDATE tiket_sehala SET tarikh_pergi=@tarikh_pergi WHERE id=@id";
            ...
            else
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            updateconnection.Open();
                            int change2 = updatecommand.ExecuteNonQuery();
                            if (change2 > 0)
                            {
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlCommandreadstatus = new SqlCommand("SELECT * FROM tiket_sehala WHERE username_pegawai=@username_pegawai", sqlConnectionstatus);
            ...
            SqlCommand sqlCommandreadstatus2 = new SqlCommand("SELECT * FROM tiket_sehala WHERE username_pegawai=@username_pegawai", sqlConnectionstatus);
        ...
        protected void Search2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlCommandreadstatus = new SqlCommand("SELECT * FROM tiket_sehala WHERE id=@id", sqlConnectionstatus);
            sqlCommandreadstatus.Parameters.Clear();
            ...
            SqlCommand sqlCommandreadstatus2 = new SqlCommand("SELECT * FROM tiket_sehala WHERE id=@id", sqlConnectionstatus);
            sqlCommandreadstatus2.Parameters.Clear();
        ...
        protected void oknotes_Click(object sender, EventArgs e)
        {
            ...
            updatecommand = new SqlCommand();
            updatecommand.Connection = updateconnection;
            updatecommand.CommandText = "UPDATE tiket_sehala SET catatan=@catatan WHERE id=@id";
