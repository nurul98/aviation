<%@ Page Title="" Language="C#" MasterPageFile="~/admin_access/admin.Master" AutoEventWireup="true" CodeBehind="senaraitempahansehala.aspx.cs" Inherits="aviation.admin_access.senaraitempahansehala" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:HyperLink ID="linksehalaadmin" runat="server" 
        NavigateUrl="~/admin_access/senaraitempahan.aspx">klik di sini </asp:HyperLink>
    untuk senarai tempahan tiket dua hala<br />
&nbsp;<br />
    <table><tr> <td class="style3">&nbsp;IC Pegawai : 
           ...
           </tr> <tr> <td class="style3">&nbsp;No. Rujukan : 
            </td>
           <td>
        ...
        AllowPaging="True" onpageindexchanging="gridtempah_PageIndexChanging">
                    <Columns>
                       ...
                       <asp:TemplateField HeaderText="Tarikh Pergi" SortExpression="tarikh_pergi">
                        ...
                        <asp:TemplateField HeaderText="Status Lulus" SortExpression="lulus">
                        <ItemTemplate>
...
<br />
    <asp:HyperLink ID="HyperLink1" runat="server" 
        NavigateUrl="~/admin_access/adminbooking.aspx">Sila klik di sini</asp:HyperLink>&nbsp; untuk membuat tempahan tiket baru<br /><br />
<table class="style1">
             <tr>
                <td class="style3">
             ...
             <tr>
                ...
                <td>
                 ...
                 &nbsp;<asp:ImageButton ID="notes" runat="server" Height="25px" 
                        ImageUrl="~/admin_access/images/pencil-icon.jpg" Width="25px" onclick="btnotes_Click" /></td>
            </tr>
            <tr>
                <td class="style3">
...
<asp:Button ID="batalnotes" runat="server" Text="Kembali" CssClass="myButton" />
  ...
  <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txttarikhpergi" Format="dd-MMM-yyyy">
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT [nama] FROM [supervisor]"></asp:SqlDataSource>   
</asp:Content>
