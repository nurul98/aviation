...
namespace aviation
{
    public partial class statuspermohonan : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("lihatfailsokongan.aspx?tiketid=" + id.Text);
        }
        protected void btnEdit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (userreader.Read())
                {
                    ...
                    {
                        LabelStatus.Text = "Status permohonan " + tiketid + " telah disokong oleh penyelia. Butir-butir perjalanan adalah seperti berikut.";
