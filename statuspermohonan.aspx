<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true" CodeBehind="statuspermohonan.aspx.cs" Inherits="aviation.statuspermohonan" %>
...
Sila 
    ...
    <asp:HyperLink ID="linkpermohonan" runat="server" 
        NavigateUrl="~/statuspermohonansehala.aspx">klik di sini </asp:HyperLink>untuk status permohonan tiket sehala
&nbsp;<br />
    <asp:GridView ID="gridtempah" runat="server" AutoGenerateColumns="False" 
        ...
        AllowPaging="True" onpageindexchanging="gridtempah_PageIndexChanging">
                   <Columns>
                       <asp:BoundField DataField="id" HeaderText="No. Rujukan" SortExpression="id" Visible="True" />
                       ...
                       <asp:TemplateField HeaderText="Tarikh Balik" SortExpression="tarikh_balik">
                        <ItemTemplate>
                            <asp:Label ID="txttarikhbalik" runat="server" Enabled="False" 
                                Text='<%# Bind("tarikh_balik","{0:d}") %>'></asp:Label>
                        </ItemTemplate>
                         </asp:TemplateField>
...
<br />
 <asp:Label ID="LabelStatus" runat="server" Text=""></asp:Label><br /><br />
    <asp:Label ID="LabelStatus2" runat="server" Text="Sila " Visible="False"></asp:Label><asp:HyperLink
        ID="LinkTempahTiket" runat="server" Visible="False" 
        NavigateUrl="~/BookingApplication.aspx">klik di sini </asp:HyperLink>
...
<table class="style1">
           ...
           <tr>
            ...
            <tr>
                <td class="style3">
                    <asp:Label ID="LabelTarikhBalik" runat="server" Text="Tarikh Balik:" Visible="False"></asp:Label>  </td>
                <td>
           ...
           <tr>
                <td class="style3">
                    <asp:Label ID="LabelWaktuPerjalanan2" runat="server" Text="Waktu Perjalanan:" Visible="False"></asp:Label>  </td>
                <td>
                    <asp:TextBox ID="waktuperjalanan2" runat="server" Width="115px" Visible="False"></asp:TextBox>
                </td>
            </tr>
           <tr>
                <td class="style3">
